...
mod tests {
    ...
    use super::{TAG_CONT, TAG_TWO, TAG_THREE, TAG_FOUR, decode_utf8, decode_last_utf8, encode_utf8};
    ...
    fn reject_invalid() {
        ...
        assert_eq!(decode_utf8(&[TAG_FOUR, TAG_CONT, TAG_CONT, TAG_CONT | b'a']),
                   None);
    }
    ...
    fn reject_invalid_last() {
        ...
        assert_eq!(decode_last_utf8(&[TAG_THREE, TAG_CONT, TAG_CONT | b'a']),
                   None);
        assert_eq!(decode_last_utf8(&[TAG_FOUR, TAG_CONT, TAG_CONT, TAG_CONT | b'a']),
                   None);
    }
}
