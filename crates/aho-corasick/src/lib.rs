...
use libtww::std::collections::VecDeque;
use libtww::std::fmt;
use libtww::std::iter::FromIterator;
use libtww::std::mem;
...
impl<P: AsRef<[u8]>, T: Transitions> AcAutomaton<P, T> {
    ...
    pub fn heap_bytes(&self) -> usize {
        ...
        self.states
            ...
            .fold(0, |a, b| a + b) + self.start_bytes.len()
    }
}
...
#[cfg(test)]
mod tests {
    use libtww::std::collections::HashSet;
    use libtww::std::io;
