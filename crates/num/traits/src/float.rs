use libtww::std::mem;
use libtww::std::ops::Neg;
use libtww::std::num::FpCategory;
...
macro_rules! float_impl {
    ($T:ident $decode:ident) => (
        impl Float for $T {
            ...
            #[inline]
            fn infinity() -> Self {
                ::libtww::std::$T::INFINITY
            }

            #[inline]
            fn neg_infinity() -> Self {
                ::libtww::std::$T::NEG_INFINITY
            }
            ...
            #[inline]
            fn min_positive_value() -> Self {
                ::libtww::std::$T::MIN_POSITIVE
            }

            #[inline]
            fn epsilon() -> Self {
                ::libtww::std::$T::EPSILON
            }
            ...
            fn to_degrees(self) -> Self {
                ...
                // <$T>::to_degrees(self)
                self * (180. / ::libtww::std::$T::consts::PI)
            }
            ...
            fn to_radians(self) -> Self {
                // NB: `f32` didn't stabilize this until 1.7
                // <$T>::to_radians(self)
                self * (::libtww::std::$T::consts::PI / 180.)
            }
