...
use libtww::std::{fmt, i64};
use libtww::std::error::Error;
use libtww::std::ops::{Add, Sub, Mul, Div, Neg, FnOnce};
use libtww::std::time::Duration as StdDuration;
...
impl Duration {
    ...
    /// Creates a `time::Duration` object from `libtww::std::time::Duration`
    ///
    ...
    /// Creates a `libtww::std::time::Duration` object from `time::Duration`
    ///
...
/// implementation
///
/// The `libtww::std::time::Duration` supports a range from zero to `u64::MAX`
...
mod tests {
    ...
    fn test_duration() {
        ...
        assert_eq!(Duration::seconds(1) + Duration::seconds(2),
                   Duration::seconds(3));
        assert_eq!(Duration::seconds(86399) + Duration::seconds(4),
                   Duration::days(1) + Duration::seconds(3));
        assert_eq!(Duration::days(10) - Duration::seconds(1000),
                   Duration::seconds(863000));
        assert_eq!(Duration::days(10) - Duration::seconds(1000000),
    ...
    fn test_duration_num_milliseconds() {
        ...
        assert_eq!(Duration::microseconds(-999).num_milliseconds(), 0);
        assert_eq!(Duration::microseconds(-1001).num_milliseconds(), -1);
        assert_eq!(Duration::milliseconds(i64::MAX).num_milliseconds(),
                   i64::MAX);
        assert_eq!(Duration::milliseconds(i64::MIN).num_milliseconds(),
                   i64::MIN);
    ...
    fn test_duration_num_microseconds() {
        ...
        assert_eq!(Duration::nanoseconds(-999).num_microseconds(), Some(0));
        assert_eq!(Duration::nanoseconds(-1001).num_microseconds(), Some(-1));
        assert_eq!(Duration::microseconds(i64::MAX).num_microseconds(),
                   Some(i64::MAX));
        assert_eq!(Duration::microseconds(i64::MIN).num_microseconds(),
                   Some(i64::MIN));
        ...
        assert_eq!(Duration::days(i64::MAX / MICROS_PER_DAY + 1).num_microseconds(),
                   None);
        assert_eq!(Duration::days(i64::MIN / MICROS_PER_DAY - 1).num_microseconds(),
                   None);
    }
    ...
    fn test_duration_num_nanoseconds() {
        ...
        assert_eq!(Duration::nanoseconds(-1).num_nanoseconds(), Some(-1));
        assert_eq!(Duration::nanoseconds(i64::MAX).num_nanoseconds(),
                   Some(i64::MAX));
        assert_eq!(Duration::nanoseconds(i64::MIN).num_nanoseconds(),
                   Some(i64::MIN));
        ...
        assert_eq!(Duration::days(i64::MAX / NANOS_PER_DAY + 1).num_nanoseconds(),
                   None);
        assert_eq!(Duration::days(i64::MIN / NANOS_PER_DAY - 1).num_nanoseconds(),
                   None);
    }
    ...
    fn test_duration_mul() {
        ...
        assert_eq!(Duration::nanoseconds(1) * 1_000_000_000,
                   Duration::seconds(1));
        assert_eq!(Duration::nanoseconds(1) * -1_000_000_000,
                   -Duration::seconds(1));
        assert_eq!(-Duration::nanoseconds(1) * 1_000_000_000,
    ...
    fn test_duration_div() {
        assert_eq!(Duration::zero() / i32::MAX, Duration::zero());
        assert_eq!(Duration::zero() / i32::MIN, Duration::zero());
        assert_eq!(Duration::nanoseconds(123_456_789) / 1,
        ...
        assert_eq!(Duration::seconds(4) / 3,
    ...
    fn test_to_std() {
        ...
        assert_eq!(Duration::seconds(86401).to_std(),
                   Ok(StdDuration::new(86401, 0)));
        assert_eq!(Duration::milliseconds(123).to_std(),
                   Ok(StdDuration::new(0, 123000000)));
        assert_eq!(Duration::milliseconds(123765).to_std(),
                   Ok(StdDuration::new(123, 765000000)));
        assert_eq!(Duration::nanoseconds(777).to_std(),
                   Ok(StdDuration::new(0, 777)));
        assert_eq!(MAX.to_std(),
