...
impl Parsed {
    ...
    pub fn set_year_div_100(&mut self, value: i64) -> ParseResult<()> {
        ...
        set_if_consistent(&mut self.year_div_100,
                          try!(value.to_i32().ok_or(OUT_OF_RANGE)))
    }
    ...
    pub fn set_year_mod_100(&mut self, value: i64) -> ParseResult<()> {
        ...
        set_if_consistent(&mut self.year_mod_100,
                          try!(value.to_i32().ok_or(OUT_OF_RANGE)))
    }
    ...
    pub fn set_isoyear_div_100(&mut self, value: i64) -> ParseResult<()> {
        ...
        set_if_consistent(&mut self.isoyear_div_100,
                          try!(value.to_i32().ok_or(OUT_OF_RANGE)))
    }
    ...
    pub fn set_isoyear_mod_100(&mut self, value: i64) -> ParseResult<()> {
        ...
        set_if_consistent(&mut self.isoyear_mod_100,
                          try!(value.to_i32().ok_or(OUT_OF_RANGE)))
    }
    ...
    pub fn set_week_from_sun(&mut self, value: i64) -> ParseResult<()> {
        set_if_consistent(&mut self.week_from_sun,
                          try!(value.to_u32().ok_or(OUT_OF_RANGE)))
    }
    ...
    pub fn set_week_from_mon(&mut self, value: i64) -> ParseResult<()> {
        set_if_consistent(&mut self.week_from_mon,
                          try!(value.to_u32().ok_or(OUT_OF_RANGE)))
    }
    ...
    pub fn set_ampm(&mut self, value: bool) -> ParseResult<()> {
        set_if_consistent(&mut self.hour_div_12,
                          if value {
                              1
                          } else {
                              0
    ...
    pub fn set_nanosecond(&mut self, value: i64) -> ParseResult<()> {
        set_if_consistent(&mut self.nanosecond,
                          try!(value.to_u32().ok_or(OUT_OF_RANGE)))
    }
    ...
    pub fn to_naive_date(&self) -> ParseResult<NaiveDate> {
        ...
        let given_year = try!(resolve_year(self.year, self.year_div_100, self.year_mod_100));
        let given_isoyear =
    ...
    pub fn to_naive_datetime_with_offset(&self, offset: i32) -> ParseResult<NaiveDateTime> {
        ...
        if let (Ok(date), Ok(time)) = (date, time) {
            ...
            match (date, time) {
                (Err(PE(OutOfRange)), _) |
                (_, Err(PE(OutOfRange))) => return Err(OUT_OF_RANGE),
                (Err(PE(Impossible)), _) |
                (_, Err(PE(Impossible))) => return Err(IMPOSSIBLE),
