    ...
    for item in items {
        match item {
            ...
            Item::Numeric(spec, _pad) => {
                ...
                let (width, signed, set): (usize, bool, fn(&mut Parsed, i64) -> ParseResult<()>) =
                    match spec {
...
fn test_rfc2822() {
    ...
    let testdates = [("Tue, 20 Jan 2015 17:35:20 -0800", Ok("Tue, 20 Jan 2015 17:35:20 -0800")), /* normal case */
...
fn test_rfc3339() {
    ...
    // Test data - (input, Ok(expected result after parse and format) or Err(error code))
    let testdates = [("2015-01-20T17:35:20-08:00", Ok("2015-01-20T17:35:20-08:00")), /* normal case */
