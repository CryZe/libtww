...
impl<T> LocalResult<T> {
    ...
    pub fn latest(self) -> Option<T> {
        match self {
            LocalResult::Single(t) |
            LocalResult::Ambiguous(_, t) => Some(t),
            _ => None,
        }
    }
...
impl<Tz: TimeZone> LocalResult<Date<Tz>> {
    ...
    pub fn and_hms_milli_opt(self,
        ...
        match self {
            LocalResult::Single(d) => {
                d.and_hms_milli_opt(hour, min, sec, milli)
                    .map_or(LocalResult::None, LocalResult::Single)
            }
            _ => LocalResult::None,
        }
    ...
    pub fn and_hms_micro_opt(self,
        ...
        match self {
            LocalResult::Single(d) => {
                d.and_hms_micro_opt(hour, min, sec, micro)
                    .map_or(LocalResult::None, LocalResult::Single)
            }
            _ => LocalResult::None,
        }
    ...
    pub fn and_hms_nano_opt(self,
        ...
        match self {
            LocalResult::Single(d) => {
                d.and_hms_nano_opt(hour, min, sec, nano)
                    .map_or(LocalResult::None, LocalResult::Single)
            }
            _ => LocalResult::None,
        }
...
pub trait TimeZone: Sized + Clone {
    ...
    fn from_local_date(&self, local: &NaiveDate) -> LocalResult<Date<Self>> {
        self.offset_from_local_date(local)
            .map(|offset| Date::from_utc(*local - offset.local_minus_utc(), offset))
    }
