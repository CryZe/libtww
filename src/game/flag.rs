...
pub const TALKED_TO_OLIVIO_ON_ISLAND: Flag = Flag(0x803B8732, 1 << 2);
...
pub const TALKED_TO_KOROK_NEXT_TO_DEKU_TREE: Flag = Flag(0x803B8735, 1 << 5);
pub const TALKED_TO_NIKO_ON_OUTSET_BEACH: Flag = Flag(0x803B8735, 1 << 6);
pub const TALKIED_TO_KORL_AT_GREATFISH: Flag = Flag(0x803B8736, 1 << 0);
...
pub const TALKED_TO_KORL_START_OF_FH_CUTSCENE: Flag = Flag(0x803B8736, 1 << 5);
...
pub const TALKED_TO_KOROK_OUTSIDE_STORE_IN_FOREST_HAVEN: Flag = Flag(0x803B8738, 1 << 4);
...
pub const WATCHED_LIGHT_BRIDGE_CUTSCENE_IN_TOTG: Flag = Flag(0x803B873A, 1 << 0);
...
pub const TALKED_TO_DEKU_TREE_AFTER_CUTSCENE: Flag = Flag(0x803B873A, 1 << 6);
...
pub const TALKED_TO_HOLLO_IN_STORE_IN_FOREST_HAVEN_AFTER_FORBIDDEN_WOODS: Flag = Flag(0x803B8748, 1 << 7);
...
pub const QUILL_TELLS_US_JABUN_IS_HIDING_ON_OUTSET: Flag = Flag(0x803B874A, 1 << 7);
pub const TALKED_TO_KORL_AFTER_GETTING_BOMBS: Flag = Flag(0x803B874B, 1 << 1);
pub const WINDFALL_PIRATE_CUTSCENE: Flag = Flag(0x803B874B, 1 << 2);
...
pub const PICKED_UP_STATUE_AND_WATCHED_DOOR_LIGHT_UP_TOTG_F1: Flag = Flag(0x803B8752, 1 << 1);
...
pub const ENTERED_KORL_AFTER_LEAVING_FH: Flag = Flag(0x803B8756, 1 << 1); // Maybe visit any quadrant?
...
pub const DESTROY_VINE_ON_DOOR_IN_FW: Flag = Flag(0x803B8757, 1 << 5);
...
pub const TALKED_TO_STURGIN_WHEN_VISITING_OUTSET_A_SECOND_TIME: Flag = Flag(0x803B8763, 1 << 3);
pub const COLORS_IN_HYRULE: Flag = Flag(0x803B8764, 1 << 1);
pub const WATCHED_COURTYARD_CUTSCENE: Flag = Flag(0x803B8764, 1 << 2);
pub const ENTERED_THE_WARP_LEAVING_HYRULE_1_AND_LOWERED_ELECTRIC_BARRIER: Flag = Flag(0x803B8764, 1 << 4);
...
pub const TALKIED_TO_LOCKED_PIRATE_SHIP_DOOR: Flag = Flag(0x803B8767, 1 << 5);
...
pub const KILL_KALLE_DEMOS_AND_SPAWN_PORTAL: Flag = Flag(0x803B8769, 1 << 6);
